...
@app.on_callback_query(filters.regex("DD"))

async def dd(_, cb : CallbackQuery):
    ...
    try:
        ...
        await cb.message.edit(text="**⚖ - بيان سياسة الاستخدام وشروط الخوصية:\n\n▫️• تسجيل الطلب في أي جزء من الروبوت يعني أنك على دراية بالشروط المذكورة في نفس الجزء وموافق عليها.\n▫️• الشراء أو البيع من رصيدك في البوت (بوت خدمات الراقي) غير محظور، ولكن الراقي لا يتحمل أي التزام أو متابعة للمعاملة.\n▫️• في حالة زيادة المشاهدات أكثر من العدد المطلوب، لا يوجد إمكانية لجعل هذا العدد أن يصبح كما طلبت، وراسین لا تتحمل أي مسؤولية.\n ▫️• عند طلب زيادة التفاعلات يجب اولا التأكد وتفعيل إمكانية التفاعل مع الرسالة المحددة سوء كان ذلك في قروب او قناة.\n ▫️• يجب ان تكون روابط جميع الطلبات عامة وليست خاصة، واذا وجد غلط في ذلك لا نتحمل مسؤولية أرجاع رصيد الطلب وسيتم إرسال علامة الطلب كـ مكتمل. \n ▫️• إستغلال الثغرات إن وجدت، أو النصب او الإحتيال في تحويل النقاط الى مشترك أخر او التلاعب باستخدام قسم الإحالة.\n▫️• قد يتم أضافة المزيد من القوانين والشروط حسب إحتياجات البوت يرجى التأكد ومراجعة الشروط من وقت لآخر.\n\n ▫️• قد تحدث اخطاء أو مشاكل  عند الطلب اكثر من مرة لنفس الرابط لذلك لا يسمح بالطلب لنفس الرابط اكثر من مرة، ولا نتحمل المسؤولية في هذا الجانب.\n\n- في حال مخالفة هذه الشروط يحق لنا : \n• تقييد حسابك دون إبلاغك.\n• حذف وايقاف جميع الطلبات التي قمت بها.**", reply_markup=back)
